  ...
  return (
    <>
      ...
      <div className={`
        ...
        w-64 lg:w-72 bg-white/80 backdrop-blur-xl shadow-2xl border-r border-gray-200/50
      ...
      `}>
        ...
        {/* Scrollable Content */}
        <div className="flex-1 overflow-y-auto px-4 pb-4 scrollbar-thin scrollbar-thumb-gray-300">
          {/* Header */}
          ...
          <div className="pt-4 border-t border-gray-200/50 space-y-2">
            <NavLink to="/profile" onClick={closeMobileMenu} className="group flex items-center px-4 py-3 text-gray-700 rounded-xl hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50">
            ...
            <NavLink to="/settings" onClick={closeMobileMenu} className="group flex items-center px-4 py-3 text-gray-700 rounded-xl hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50">
            ...
            <button onClick={() => { logout(); closeMobileMenu(); }} className="group flex items-center w-full px-4 py-3 text-gray-700 rounded-xl hover:bg-gradient-to-r hover:from-red-50 hover:to-pink-50 hover:text-red-600">
